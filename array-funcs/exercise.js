...
function totalPerRegion(periodicRegionalRainfall) {
  return periodicRegionalRainfall.map(function (regionalRainfall) {
    return regionalRainfall.reduce(function (runningTotal, periodRainfall) {
      return runningTotal + periodRainfall;
    }, 0);
  });
}
